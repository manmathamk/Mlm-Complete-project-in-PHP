...
// $sender_name = "Akshaya.asia";
// 	$sender_email = "akshaya.asia@gmail.com";
// 	//
// 	$username = "akshaya.asia@gmail.com";
// 	$password = "ruiwjzyzirdvrhct";
// 	//
// 	$receiver_email = $emailid;
// 	$message = $admin_body;
// 	$subject = "Thank You - Akshaya";
  ...
  <div class="col-md-6">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                              <input type="text" id="animaloption" name="under_userid" class="form-control" placeholder="Up-line ID" value="<?php echo isset($under_userid) ? $under_userid : ''; ?>" <?php echo isset($under_userid) ? 'readonly' : ''; ?>>
                                            </div>
                                             <div id="kind"></div>
                                        </div>
                                    </div>
