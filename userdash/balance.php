...
?>
    ...
    <section class="content">
        <div class="container-fluid">
        	<div class="align-center m-t-15 font-bold"><h3>Balance Payments</h3></div>
                            <ol class="breadcrumb breadcrumb-bg-cyan align-center">
                                ...
                                <li class="active"><i class="material-icons">archive</i> Balance</li>
                            </ol>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            $query = mysqli_query($con,"select * from income where userid='$userid' order by id desc");
                            if(mysqli_num_rows($query)>0){
                                while($row=mysqli_fetch_array($query)){
                                    $day_bal = $row['current_bal'];
                                    // $tds = $row['tds'];
                                    // $total = $row['total_bal'];
