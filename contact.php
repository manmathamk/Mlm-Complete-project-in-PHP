...
<body>
  ...
  <div class="footer_section layout_padding">
    <div class="container">
      <div class="footer_main">
        ...
        <h1 class="landing_text">It is the ultimate vehicle for achieving financial freedom, personal growth, and making
          a positive impact on the world. </h1>
      </div>
  ...
  <div class="copyright_section">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <p class="copyright_text">2020 All Rights Reserved Design by <a href="#"> Akshaya</p>
        </div>
      </div>
    </div>
  </div>
