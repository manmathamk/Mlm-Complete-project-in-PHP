...
<body>
  ...
  <div class="service_section layout_padding margin_0">
    <div class="container">
      <h1 class="about_text">Plans</h1>
      <p class="ipsum_text">Package plans offer convenience and savings, making it easier for you to get more value for
  ...
  <div class="footer_section layout_padding margin_0">
    <div class="container">
      <div class="footer_main">
        ...
        <h1 class="landing_text">Join the Akshaya movement and become part of a supportive community of individuals
          dedicated to helping each other succeed. </h1>
      </div>
